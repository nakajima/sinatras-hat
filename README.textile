...
You can nest one level of child resources using the @children@ option:

  mount Post, :children => :comments

Using that snippet, you'll get the following routes:
  
* @GET  /posts/:post_id/comments@
* @POST /posts/:post_id/comments@ (not implemented yet)
* @GET  /posts/:post_id/comments/:id@ 
* @PUT  /posts/:post_id/comments/:id@ (not implemented yet)
* @DELETE /posts/:post_id/comments/:id@ (not implemented yet)

Your nested resources will be accessed using the same @finder@ and @record@ options as are
...
h4. Projects using it

* "ActiveRecorder":http://github.com/nakajima/activerecorder
* "JavaScript demos":http://github.com/nakajima/javascript-demos

h4. TODO

* Abstract jQuery-esque pattern for option methods (@only@, @protect@, etc)
* Refactor actions (maybe an Action class?)
* Nesting resources should work like this:
  ...
  This would allow nested options to be tracked as well.
